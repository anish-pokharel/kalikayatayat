...
//   // UPDATED: Add 'counter' to the type
//   fillCredentials(type: 'admin' | 'user' | 'counter'): void {
//     if (type === 'admin') {
//       this.loginData.email = 'admin@gmail.com';
//       this.loginData.password = 'anish123';
//     } else if (type === 'counter') {
//       this.loginData.email = 'counter@gmail.com';
//       this.loginData.password = 'counter123';
//     } else {
//       this.loginData.email = 'anish.pokharel.710.ap@gmail.com';
//       this.loginData.password = 'anish123';
//     }
...
//   // UPDATED: Add counter redirect logic
//   private redirectBasedOnRole(): void {
//     if (this.authService.isAdmin()) {
//       this.router.navigate(['/admin/dashboard']);
//     } else if (this.authService.isCounter()) {
//       this.router.navigate(['/counter/dashboard']); // Navigate to counter dashboard
//     } else {
//       this.router.navigateByUrl(this.returnUrl);
//     }
//   }
...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  private redirectBasedOnRole(): void {
    ...
    if (this.authService.isAdmin()) {
      ...
      console.log('Redirecting to counter dashboard');
